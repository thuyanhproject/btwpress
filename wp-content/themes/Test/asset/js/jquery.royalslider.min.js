...
(function(l) {
    function t(b, f) {
        ...
        window.requestAnimationFrame ||
            (window.requestAnimationFrame = function(a) { var b = (new Date).getTime(),
                    d = Math.max(0, 16 - (b - k)),
                    c = window.setTimeout(function() { a(b + d) }, d);
                k = b + d; return c });
        ...
        a._p = 0;
        a._q = 0;
        l.each(l.rsModules, function(b, d) { "uid" !== b && d.call(a) });
        a.slides = [];
        a._r = 0;
        ...
        a._p1.click(function(b) { if (!a.dragSuccess) { var d = l(b.target).attr("class"); if (-1 !== l.inArray(d, m) && a.toggleVideo()) return !1; if (a.st.navigateByClick && !a._h2) { if (l(b.target).closest(".rsNoDrag", a._r1).length) return !0;
                    a._i2(b) } a.ev.trigger("rsSlideClick") } }).on("click.rs", "a", function() {
    ...
    t.prototype = {
        ...
        _s: function(b, f) {
            function c(a, b) { b ? e.images.push(a.attr(b)) : e.images.push(a.text()); if (j) { j = !1;
                    ...
                    e.image = e.images[0];
                    e.videoURL = a.attr("data-rsVideo"); var d = a.attr("data-rsw"),
                        c = a.attr("data-rsh"); "undefined" !== typeof d && !1 !== d && "undefined" !== typeof c && !1 !== c ? (e.iW = parseInt(d), e.iH = parseInt(c)) : h.st.imgWidth && h.st.imgHeight && (e.iW = h.st.imgWidth, e.iH = h.st.imgHeight) } }
            var h = this,
                a, e = {},
                d, j = !0;
            b = l(b);
            ...
            h.ev.trigger("rsBeforeParseNode",
                [b, e]);
            if (!e.stopParsing) return b = h._k2, e.id = h._r, e.contentAdded = !1, h._r++, e.images = [], e.isBig = !1, e.hasCover || (b.hasClass("rsImg") ? (d = b, a = !0) : (d = b.find(".rsImg"), d.length && (a = !0)), a ? (e.bigImage = d.eq(0).attr("data-rsBigImg"), d.each(function() { var a = l(this);
                    a.is("a") ? c(a, "href") : a.is("img") ? c(a, "src") : c(a) })) : b.is("img") && (b.addClass("rsImg rsMainSlideImage"), c(b, "src"))), d = b.find(".rsCaption"), d.length && (e.caption = d.remove()), e.content = b, h.ev.trigger("rsAfterParseNode", [b, e]), f && h.slides.push(e), 0 ===
                e.images.length && (e.isLoaded = !0, e.isRendered = !1, e.isLoading = !1, e.images = null), e
        },
        _b2: function() { var b = this,
                f, c, h = function(a) { 37 === a ? b.prev() : 39 === a && b.next() };
            b._b.on("keydown" + b.ns, function(a) { if (!b._l2 && (c = a.keyCode, (37 === c || 39 === c) && !f)) h(c), f = setInterval(function() { h(c) }, 700) }).on("keyup" + b.ns, function() { f && (clearInterval(f), f = null) }) },
        ...
        _n2: function(b, f) {
            function c(c, e, f) { c.isAdded ? (h(e, c), a(e, c)) : (f || (f = d.slidesJQ[e]), c.holder ? f = c.holder : (f = d.slidesJQ[e] = l(f), c.holder = f), c.appendOnLoaded = !1, a(e, c, f), h(e, c), d._p2(c, f, b), appended = c.isAdded = !0) }
            ...
            var m = d.currSlideId,
                ...
                s;
            for (g = m; g < m + 1 + r; g++)
                if (s = e(g), (j = d.slides[s]) && (!j.isAdded || !j.positionSet)) { u = !0; break } for (g = m - 1; g > m - 1 - r; g--)
        ...
        setItemHtml: function(b, f) {
            function c() {
                if (b.images) {
                    if (!b.isLoading) {
                        ...
                        a && !a.is("img") && a.each(function() { var a = l(this),
                        ...
                        b.isLoading = !0;
                        if (b.isBig) l("<img />").on("load.rs error.rs", function() { h([this], !0) }).attr("src", b.image);
                        else {
                            b.loaded = [];
                            b.imgLoaders = [];
                            for (a = 0; a < b.images.length; a++) {
                                ...
                                d.on("load.rs error.rs",
                                    function() { b.loaded.push(this);
                                        b.loaded.length === b.imgLoaders.length && h(b.loaded, !1) }).attr("src", b.images[a])
                            }
                        }
                    }
            ...
            function h(c, d) { if (c.length) { var e = c[0]; if (d !== b.isBig)(e = b.holder.children()) && 1 < e.length && g();
                    else if (b.iW && b.iH) a();
                    else if (b.iW = e.width, b.iH = e.height, b.iW && b.iH) a();
                    else { var f = new Image;
                        f.onload = function() { f.width ? (b.iW = f.width, b.iH = f.height, a()) : setTimeout(function() { f.width && (b.iW = f.width, b.iH = f.height);
                                a() }, 1E3) };
                        f.src = e.src } } else a() }

            function a() { b.isLoaded = !0;
                b.isLoading = !1;
                e();
                g();
                d() }
            ...
            function e() {
                if (!b.isAppended) {
                    var a = k.st.visibleNearby,
                        c = b.id - k._o;
                    if (!f && !b.appendOnLoaded && k.st.fadeinLoadedSlide && (0 === c || (a || k._r2 || k._l2) && (-1 === c || 1 === c))) a = { visibility: "visible", opacity: 0 }, a[k._g + "transition"] = "opacity 400ms ease-in-out", b.content.css(a), setTimeout(function() { b.content.css("opacity", 1) }, 16);
                    b.holder.find(".rsPreloader").length ? b.holder.append(b.content) : b.holder.html(b.content);
                    b.isAppended = !0;
                    b.isLoaded && (k._q2(b), d());
                    b.sizeReady || (b.sizeReady = !0, setTimeout(function() { k.ev.trigger("rsMaybeSizeReady", b) }, 100))
                }
            }
            ...
            function j() { k.st.usePreloader && b.holder.html(k._q1.clone()) }

            function g() { if (k.st.usePreloader) { var a = b.holder.find(".rsPreloader");
                    a.length && a.remove() } }
            var k = this;
        ...
        _g2: function(b, f) {
            ...
            if (c._l2) a && (c._v2 = !0);
                ...
                a && (c._v2 = !1);
                c._w2();
                if (a) { var e = b.originalEvent.touches; if (e && 0 < e.length) h = e[0], 1 < e.length && (c._v2 = !0);
                    else return } else b.preventDefault(), h = b, c.msEnabled && (h = h.originalEvent);
                c._l2 = !0;
                c._b.on(c._k1,
                    function(a) { c._x2(a, f) }).on(c._l1, function(a) { c._y2(a, f) });
                c._z2 = "";
                c._a3 = !1;
                c._b3 = h.pageX;
                c._c3 = h.pageY;
        ...
        _x2: function(b, f) {
            ...
            if (!c._s2 || a) {
                ...
                else if (e = !f ? c._h : c._e3, h = Math.abs(h.pageX - c._b3) - Math.abs(h.pageY - c._c3) - (e ? -7 : 7), 7 < h) { if (e) b.preventDefault(), c._z2 = "x";
                    else if (a) { c._v3(); return } c._l3 = !0 } else if (-7 > h) { if (e) { if (a) { c._v3(); return } } else b.preventDefault(), c._z2 = "y";
                    c._l3 = !0 }
            }
        },
        _v3: function() {
        ...
        _y2: function(b, f) {
            ...
            function h(b, d) { if (a._l || f) j = (-a._u - a._d1) * a._w, g = Math.abs(a._p - j), a._c = g / d, b && (a._c += 250), a._c = c(a._c), a._x3(j, !1) }
            var a = this,
                e, d, j, g;
            d = "touchend" === b.type || "touchcancel" === b.type;
            if (!a._s2 || d)
                if (a._s2 = !1, a.ev.trigger("rsDragRelease"), a._u3 = null, a._l2 = !1, a._r3 = !1, a._l3 = !1, a._m3 = 0, cancelAnimationFrame(a._t3), a._a3 && (f ? a._q3(a._h3) : a._l && a._p3(a._h3)), a._b.off(a._k1).off(a._l1), d && a._e1.off(a._m1), a._i1(),
                    !a._a3 && !a._v2 && f && a._w3) { var k = l(b.target).closest(".rsNavItem");
                    ...
                    if (!a._a3 || "y" === a._z2 && e || "x" === a._z2 && !e)
                        if (!f && a._t2) { a._t2 = !1; if (a.st.navigateByClick) { a._i2(a.msEnabled ? b.originalEvent : b);
                                a.dragSuccess = !0; return } a.dragSuccess = !0 } else { a._t2 = !1;
                    ...
                    if (0 === u || 1 >= r) h(!0, d);
                        ...
                        if (!t && !f)
                            if (0 >= q) { if (0 < u) { h(!0, d); return } } else if (q >= r - 1 && 0 > u) { h(!0, d); return }
                        if (f) {
                            j = a._i3;
                            if (j > a._n3) j = a._n3;
        ...
        _g4: function() {
            ...
            b._i4 = setTimeout(function() { b._l && b._p3((-b._u - b._d1) * b._w);
                b._n2();
        ...
        _m2: function(b, f, c, h, a) {
            ...
            if (!e._z) { if (0 > newItemId) { e._j4("left", !h); return } if (newItemId >= e.numSlides) { e._j4("right", !h); return } } e._r2 && (e._u2(!0), c = !1);
        ...
        _x3: function(b, f, c, h, a) {
            function e() { var a; if (j && (a = j.data("rsTimeout"))) j !== g && j.css({ opacity: 0, display: "none", zIndex: 0 }), clearTimeout(a), j.data("rsTimeout", ""); if (a = g.data("rsTimeout")) clearTimeout(a), g.data("rsTimeout", "") }
            var d = this,
                j, g, k = {};
            isNaN(d._c) && (d._c = 400);
            d._p = d._h3 = b;
            ...
            d._e ? d._l ? (d._c = parseInt(d._c),
                c = d._g + d._v1, k[d._g + d._u1] = d._c + "ms", k[c] = h ? l.rsCSS3Easing[d.st.easeInOut] : l.rsCSS3Easing[d.st.easeOut], d._p1.css(k), h || !d.hasTouch ? setTimeout(function() { d._p3(b) }, 5) : d._p3(b)) : (d._c = d.st.transitionSpeed, j = d._h4, g = d._r1, g.data("rsTimeout") && g.css("opacity", 0), e(), j && j.data("rsTimeout", setTimeout(function() { k[d._g + d._u1] = "0ms";
                    k.zIndex = 0;
                    k.display = "none";
                    j.data("rsTimeout", "");
                    j.css(k);
                    setTimeout(function() { j.css("opacity", 0) }, 16) }, d._c + 60)), k.display = "block", k.zIndex = d._m, k.opacity = 0, k[d._g + d._u1] =
                "0ms", k[d._g + d._v1] = l.rsCSS3Easing[d.st.easeInOut], g.css(k), g.data("rsTimeout", setTimeout(function() { g.css(d._g + d._u1, d._c + "ms");
                    g.data("rsTimeout", setTimeout(function() { g.css("opacity", 1);
                        g.data("rsTimeout", "") }, 20)) }, 20))) : d._l ? (k[d._h ? d._x1 : d._w1] = b + "px", d._p1.animate(k, d._c, h ? d.st.easeInOut : d.st.easeOut)) : (j = d._h4, g = d._r1, g.stop(!0, !0).css({ opacity: 0, display: "block", zIndex: d._m }), d._c = d.st.transitionSpeed, g.animate({ opacity: 1 }, d._c, d.st.easeInOut), e(), j && j.data("rsTimeout", setTimeout(function() {
                j.stop(!0,
        ...
        _u2: function(b) {
            ...
            if (this._l)
                if (this._e) { if (!b) { b = this._p; var f = this._h3 = this._m4();
                        this._p1.css(this._g + this._u1, "0ms");
                        b !== f && this._p3(f) } } else this._p1.stop(!0), this._p = parseInt(this._p1.css(this._x1),
                    10);
            else 20 < this._m ? this._m = 10 : this._m++
        },
        _m4: function() { var b = window.getComputedStyle(this._p1.get(0), null).getPropertyValue(this._g + "transform").replace(/^matrix\(/i, "").split(/, |\)$/g),
                f = 0 === b[0].indexOf("matrix3d"); return parseInt(b[this._h ? f ? 12 : 4 : f ? 13 : 5], 10) },
        _n4: function(b, f) { return this._e ? this._y1 + (f ? b + this._z1 + 0 : 0 + this._z1 + b) + this._a2 : b },
        _l4: function() { this._l || (this._r1.css("z-index", 0), this._m = 10);
            this._r2 = !1;
            this.staticSlideId = this.currSlideId;
            this._n2();
            this._o4 = !1;
            this.ev.trigger("rsAfterSlideChange") },
        _j4: function(b, f) { var c = this,
                h = (-c._u - c._d1) * c._w; if (!(0 === c.numSlides || c._r2))
                if (c.st.loopRewind) c.goTo("left" === b ? c.numSlides - 1 : 0, f);
                else if (c._l) { c._c = 200; var a = function() { c._r2 = !1 };
                c._x3(h + ("left" === b ? 30 : -30), "", !1, !0, function() { c._r2 = !1;
                    c._x3(h, "", !1, !0, a) }) } },
        _q2: function(b) {
            if (!b.isRendered) {
                var f = b.content,
    ...
    l.extend(jQuery.easing, { easeInOutSine: function(b, f, c, h, a) { return -h / 2 * (Math.cos(Math.PI * f / a) - 1) + c }, easeOutSine: function(b, f, c, h, a) { return h * Math.sin(f / a * (Math.PI / 2)) + c }, easeOutCubic: function(b, f, c, h, a) { return h * ((f = f / a - 1) * f * f + 1) + c } })
})(jQuery, window);
// jquery.rs.active-class v1.0.1
(function(c) { c.rsProto._p4 = function() { var b, a = this; if (a.st.addActiveClass) a.ev.on("rsOnUpdateNav", function() { b && clearTimeout(b);
            b = setTimeout(function() { a._h4 && a._h4.removeClass("rsActiveSlide");
                a._r1 && a._r1.addClass("rsActiveSlide");
                b = null }, 50) }) };
    c.rsModules.activeClass = c.rsProto._p4 })(jQuery);
// jquery.rs.animated-blocks v1.0.6
(function(j) {
    j.extend(j.rsProto, {
        _q4: function() {
            function l() { var f = a.currSlide; if (a.currSlide && a.currSlide.isLoaded && a._u4 !== f) { if (0 < a._t4.length) { for (b = 0; b < a._t4.length; b++) clearTimeout(a._t4[b]);
                        a._t4 = [] } if (0 < a._s4.length) { var e; for (b = 0; b < a._s4.length; b++)
                        ...
                        a._s4 = [] } f.animBlocks && (f.animBlocksDisplayed = !0, a._u4 = f, a._v4(f.animBlocks)) } }
            var a = this,
                b;
            a._r4 = {
                fadeEffect: !0,
            ...
            a.ev.on("rsBeforeParseNode", function(a, b, c) { b = j(b);
                c.animBlocks = b.find(".rsABlock").css("display", "none");
                c.animBlocks.length || (c.animBlocks = b.hasClass("rsABlock") ? b.css("display", "none") : !1) });
            a.ev.on("rsAfterContentSet", function(b, e) { e.id === a.slides[a.currSlideId].id && setTimeout(function() { l() }, a.st.fadeinLoadedSlide ? 300 : 0) });
            a.ev.on("rsAfterSlideChange", function() { l() })
        },
        _w4: function(j, a) { setTimeout(function() { j.css(a) }, 6) },
        _v4: function(l) {
            var a = this,
                b, f, e, c;
            a._t4 = [];
            l.each(function(l) {
                ...
                a._w4(b, e);
                a._t4.push(setTimeout(function(b, d, c, g) { return function() { b.css("display", "block"); if (c) { var f = {}; if (a._e) { var e = "";
                                ...
                                b.css(f);
                                setTimeout(function() { b.css(d) }, 24) } else setTimeout(function() { b.animate(d, c.speed, c.easing) }, 16) } delete a._t4[g] } }(b, f, c, l), 6 >= c.delay ? 12 : c.delay))
            })
        }
    });
...
(function(b) {
    b.extend(b.rsProto, {
        _y4: function() { var a = this,
                d;
            a._z4 = { enabled: !1, stopAtAction: !0, pauseOnHover: !0, delay: 2E3 };!a.st.autoPlay && a.st.autoplay && (a.st.autoPlay = a.st.autoplay);
            a.st.autoPlay = b.extend({}, a._z4, a.st.autoPlay);
            a.st.autoPlay.enabled && (a.ev.on("rsBeforeParseNode", function(a, c, f) { c = b(c); if (d = c.attr("data-rsDelay")) f.customDelay = parseInt(d, 10) }), a.ev.one("rsAfterInit", function() { a._a5() }), a.ev.on("rsBeforeDestroy", function() { a.stopAutoPlay();
                b(window).off("blur" + a.ns + " focus" + a.ns) })) },
        _a5: function() {
            var a = this;
            a.startAutoPlay();
            a.ev.on("rsAfterContentSet", function(b, e) {!a._l2 && (!a._r2 && a._b5 && e === a.currSlide) && a._c5() });
            a.ev.on("rsDragRelease", function() { a._b5 && a._d5 && (a._d5 = !1, a._c5()) });
            a.ev.on("rsAfterSlideChange", function() { a._b5 && a._d5 && (a._d5 = !1, a.currSlide.isLoaded && a._c5()) });
            a.ev.on("rsDragStart", function() { a._b5 && (a.st.autoPlay.stopAtAction ? a.stopAutoPlay() : (a._d5 = !0, a._e5())) });
            a.ev.on("rsBeforeMove", function(b, e, c) {
                a._b5 && (c && a.st.autoPlay.stopAtAction ? a.stopAutoPlay() :
                    (a._d5 = !0, a._e5()))
            });
            a._f5 = !1;
            a.ev.on("rsVideoStop", function() { a._b5 && (a._f5 = !1, a._c5()) });
            a.ev.on("rsVideoPlay", function() { a._b5 && (a._d5 = !1, a._e5(), a._f5 = !0) });
            b(window).on("blur" + a.ns, function() { a._b5 && (a._d5 = !0, a._e5()) }).on("focus" + a.ns, function() { a._b5 && a._d5 && (a._d5 = !1, a._c5()) });
            a.st.autoPlay.pauseOnHover && (a._g5 = !1, a.slider.hover(function() { a._b5 && (a._d5 = !1, a._e5(), a._g5 = !0) }, function() { a._b5 && (a._g5 = !1, a._c5()) }))
        },
        toggleAutoPlay: function() { this._b5 ? this.stopAutoPlay() : this.startAutoPlay() },
        startAutoPlay: function() { this._b5 = !0;
            this.currSlide.isLoaded && this._c5() },
        stopAutoPlay: function() { this._f5 = this._g5 = this._d5 = this._b5 = !1;
            this._e5() },
        _c5: function() { var a = this;!a._g5 && !a._f5 && (a._h5 = !0, a._i5 && clearTimeout(a._i5), a._i5 = setTimeout(function() { var b;!a._z && !a.st.loopRewind && (b = !0, a.st.loopRewind = !0);
                a.next(!0);
...
(function(c) {
    c.extend(c.rsProto, {
        _j5: function() {
            var a = this;
            "bullets" === a.st.controlNavigation && (a.ev.one("rsAfterPropsSetup", function() { a._k5 = !0;
                ...
                a._l5.on("click.rs", ".rsNavItem", function() { a._n5 || a.goTo(c(this).index()) }) }), a.ev.on("rsOnAppendSlide", function(b, c, d) {
            ...
            }), a.ev.on("rsOnRemoveSlide", function(b, c) { var d = a._m5.eq(c);
                d && d.length && (d.remove(), a._m5 = a._l5.children()) }), a.ev.on("rsOnUpdateNav", function() { var b = a.currSlideId;
...
(function(c) {
    c.extend(c.rsProto, {
        _r5: function() { var a = this;
            a._s5 = { enabled: !1, keyboardNav: !0, buttonFS: !0, nativeFS: !1, doubleTap: !0 };
            a.st.fullscreen = c.extend({}, a._s5, a.st.fullscreen); if (a.st.fullscreen.enabled) a.ev.one("rsBeforeSizeSet", function() { a._t5() }) },
        _t5: function() {
            var a = this;
            ...
            if (a.st.fullscreen.nativeFS) {
                ...
                if (!a.isAndroid)
                    if ("undefined" != typeof document.cancelFullScreen) a._v5.supportsFullScreen = !0;
                        ...
                        for (var d = 0; d < b.length; d++)
                            if (a._v5.prefix = b[d], "undefined" != typeof document[a._v5.prefix + "CancelFullScreen"]) { a._v5.supportsFullScreen = !0; break } a._v5.supportsFullScreen ? (a.nativeFS = !0, a._v5.fullScreenEventName = a._v5.prefix + "fullscreenchange" + a.ns, a._v5.isFullScreen = function() {
                    switch (this.prefix) {
                        case "":
                ...
                }, a._v5.requestFullScreen = function(a) { return "" === this.prefix ? a.requestFullScreen() : a[this.prefix + "RequestFullScreen"]() }, a._v5.cancelFullScreen = function() { return "" === this.prefix ? document.cancelFullScreen() : document[this.prefix + "CancelFullScreen"]() }) : a._v5 = !1
            }
            a.st.fullscreen.buttonFS && (a._w5 = c('<div class="rsFullscreenBtn"><div class="rsFullscreenIcn"></div></div>').appendTo(a._o1).on("click.rs", function() { a.isFullscreen ? a.exitFullscreen() : a.enterFullscreen() }))
        },
        enterFullscreen: function(a) {
            var b = this;
            if (b._v5)
                if (a) b._v5.requestFullScreen(c("html")[0]);
                else { b._b.on(b._v5.fullScreenEventName, function() { b._v5.isFullScreen() ? b.enterFullscreen(!0) : b.exitFullscreen(!0) });
                    b._v5.requestFullScreen(c("html")[0]); return } if (!b._x5) {
                b._x5 = !0;
        ...
        exitFullscreen: function(a) {
            var b = this;
            if (b._v5) { if (!a) { b._v5.cancelFullScreen(c("html")[0]); return } b._b.off(b._v5.fullScreenEventName) }
            if (!b._x5) {
                b._x5 = !0;
...
(function(b) { b.extend(b.rsProto, { _e6: function() { var a = this;
    ...
    b.rsModules.globalCaption = b.rsProto._e6 })(jQuery);
// jquery.rs.nav-auto-hide v1.0
(function(b) { b.extend(b.rsProto, { _f6: function() { var a = this; if (a.st.navAutoHide && !a.hasTouch) a.ev.one("rsAfterInit", function() { if (a._l5) { a._l5.addClass("rsHidden"); var b = a.slider;
                    b.one("mousemove.controlnav", function() { a._l5.removeClass("rsHidden") });
                    b.hover(function() { a._l5.removeClass("rsHidden") }, function() { a._l5.addClass("rsHidden") }) } }) } });
    b.rsModules.autoHideNav = b.rsProto._f6 })(jQuery);
    ...
    e.extend(e.rsProto, {
        _g6: function() {
            ...
            "tabs" === a.st.controlNavigation && (a.ev.on("rsBeforeParseNode", function(a, d, b) { d = e(d);
                ...
                b.thumbnail.length ? b.thumbnail = e(document.createElement("div")).append(b.thumbnail).html() : (b.thumbnail = d.attr("data-rsTmb"), b.thumbnail || (b.thumbnail = d.find(".rsImg").attr("data-rsTmb")), b.thumbnail = b.thumbnail ? '<img src="' + b.thumbnail + '"/>' : "") }), a.ev.one("rsAfterPropsSetup", function() { a._h6() }), a.ev.on("rsOnAppendSlide",
                function(c, d, b) { b >= a.numSlides ? a._l5.append('<div class="rsNavItem rsTab">' + d.thumbnail + "</div>") : a._m5.eq(b).before('<div class="rsNavItem rsTab">' + item.thumbnail + "</div>");
                    a._m5 = a._l5.children() }), a.ev.on("rsOnRemoveSlide", function(c, d) { var b = a._m5.eq(d);
                b && (b.remove(), a._m5 = a._l5.children()) }), a.ev.on("rsOnUpdateNav", function() { var c = a.currSlideId;
                a._o5 && a._o5.removeClass("rsNavSelected");
                c = a._m5.eq(c);
        ...
        _h6: function() {
            ...
            a.slider.append(c);
            a._l5.click(function(b) { b = e(b.target).closest(".rsNavItem");
    ...
    f.extend(f.rsProto, {
        _i6: function() {
            ...
            "thumbnails" === a.st.controlNavigation && (a._j6 = { drag: !0, touch: !0, orientation: "horizontal", navigation: !0, arrows: !0, arrowLeft: null, arrowRight: null, spacing: 4, arrowsAutoHide: !1, appendSpan: !1, transitionSpeed: 600, autoCenter: !0, fitInViewport: !0, firstMargin: !0, paddingTop: 0, paddingBottom: 0 }, a.st.thumbs = f.extend({}, a._j6, a.st.thumbs), a._k6 = !0, !1 === a.st.thumbs.firstMargin ? a.st.thumbs.firstMargin = 0 : !0 === a.st.thumbs.firstMargin && (a.st.thumbs.firstMargin =
                ...
                b.thumbnail.length ? b.thumbnail = f(document.createElement("div")).append(b.thumbnail).html() : (b.thumbnail = c.attr("data-rsTmb"), b.thumbnail || (b.thumbnail = c.find(".rsImg").attr("data-rsTmb")), b.thumbnail = b.thumbnail ? '<img src="' + b.thumbnail + '"/>' : "") }), a.ev.one("rsAfterPropsSetup", function() { a._l6() }), a._o5 = null, a.ev.on("rsOnUpdateNav", function() {
            ...
            }), a.ev.on("rsOnAppendSlide", function(e, c, b) { e = "<div" + a._o6 + ' class="rsNavItem rsThumb">' + a._p6 + c.thumbnail + "</div>";
                b >= a.numSlides ? a._s3.append(e) : a._m5.eq(b).before(e);
                a._m5 = a._s3.children();
                a.updateThumbsSize() }), a.ev.on("rsOnRemoveSlide", function(e, c) { var b = a._m5.eq(c);
        ...
        _l6: function() {
            ...
            }), a._t6.click(function() { var b = (Math.floor(a._i3 / a._u6) - a._v6) * a._u6;
                a._a4(b < a._o3 ? a._o3 : b) }), c.arrowsAutoHide && !a.hasTouch && (a._s6.css("opacity", 0), a._t6.css("opacity", 0), b.one("mousemove.rsarrowshover", function() { a._m6 && (a._s6.css("opacity", 1), a._t6.css("opacity", 1)) }), b.hover(function() { a._m6 && (a._s6.css("opacity", 1), a._t6.css("opacity", 1)) }, function() { a._m6 && (a._s6.css("opacity", 0), a._t6.css("opacity", 0)) })));
            a._l5 = b;
            a._m5 = a._s3.children();
            ...
            a._l5.on("click.rs", ".rsNavItem", function() { a._n5 || a.goTo(f(this).index()) });
            a.ev.off("rsBeforeSizeSet.thumbs").on("rsBeforeSizeSet.thumbs", function() { a._x6 = a._e3 ? a._c4 : a._b4;
        ...
        updateThumbsSize: function() {
            ...
            if (a._y3 < a._z3) a.st.thumbs.autoCenter && a._q3((a._z3 - a._y3) / 2), a.st.thumbs.arrows && a._s6 && (a._s6.addClass("rsThumbsArrowDisabled"), a._t6.addClass("rsThumbsArrowDisabled")), a._m6 = !1, a._n5 = !1, a._l5.off(a._j1);
                    ...
                    a.hasTouch && a.st.thumbs.touch)) a._n5 = !0, a._l5.on(a._j1, function(b) { a._g2(b, !0) });
        ...
        setThumbsOrientation: function(a, e) { this._w3 && (this.st.thumbs.orientation = a, this._l5.remove(), this.slider.removeClass("rsWithThumbsHor rsWithThumbsVer"), this._l6(), this._l5.off(this._j1), e || this.updateSliderSize(!0)) },
        _q3: function(a) {
            this._i3 =
                a;
        ...
        _a4: function(a, e, c, b, g) {
            ...
            if (d._m6) {
                ...
                b && (d._i3 = b);
                d._z6();
                d._y6 = setTimeout(function() { d._q6 = !1;
                    g && (d._a4(b, g, !0), g = null) }, e)
            }
        },
        _z6: function() { this._r6 && (this._i3 === this._n3 ? this._s6.addClass("rsThumbsArrowDisabled") : this._s6.removeClass("rsThumbsArrowDisabled"), this._i3 === this._o3 ? this._t6.addClass("rsThumbsArrowDisabled") : this._t6.removeClass("rsThumbsArrowDisabled")) },
        _n6: function(a, e) {
            var c = 0,
    ...
    f.extend(f.rsProto, {
        _a7: function() {
            ...
            a.st.video = f.extend({}, a._b7,
                a.st.video);
            a.ev.on("rsBeforeSizeSet", function() { a._c7 && setTimeout(function() { var b = a._r1,
                        b = b.hasClass("rsVideoContainer") ? b : b.find(".rsVideoContainer");
                    a._d7 && a._d7.css({ width: b.width(), height: b.height() }) }, 32) });
            var c = a._a.mozilla;
        ...
        toggleVideo: function() { return this._c7 ? this.stopVideo() : this.playVideo() },
        playVideo: function() {
            var a = this;
            if (!a._c7) {
                var c = a.currSlide;
                ...
                a.videoObj.length && (a._d7 = f('<div class="rsVideoFrameHolder"><div class="rsPreloader"></div><div class="rsCloseVideoBtn"><div class="rsCloseVideoIcn"></div></div></div>'), a._d7.find(".rsPreloader").after(a.videoObj), b = b.hasClass("rsVideoContainer") ? b : b.find(".rsVideoContainer"), a._d7.css({
                    width: b.width(),
                    height: b.height()
                }).find(".rsCloseVideoBtn").off("click.rsv").on("click.rsv", function(b) { a.stopVideo();
                    b.preventDefault();
                    b.stopPropagation(); return !1 }), b.append(a._d7), a.isIPAD && b.addClass("rsIOSVideo"), a._f7(!1), setTimeout(function() { a._d7.addClass("rsVideoActive") }, 10), a.ev.trigger("rsVideoPlay"), a._c7 = !0);
                return !0
            }
            return !1
        },
        stopVideo: function() {
            ...
            return a._c7 ? (a.isIPAD && a.slider.find(".rsCloseVideoBtn").remove(), a._f7(!0), setTimeout(function() {
                ...
                if (c.length) try { c.attr("src", "") } catch (b) {} a._d7.remove();
                a._d7 = null
